			...
			<li className="flex justify-center w-[60px] h-[34px] px-[6px] py-[1px]">
				...
				<DropdownMenu>
					...
					<DropdownMenuLabel className="flex gap-4 w-full">
						<img
						className="w-[36px] h-[36px] rounded-full aspect-[1/1]"
						src="my foto.jpg"
						/>
						<div className=" items-center">
						<p>SALOHIDDIN GULBOYEV</p>
						<p className="drop-p text-sm text-current">@gulboyev_1</p>
						<p className=" cursor-pointer drop-p2 text-[#095ED5]">
							チャンネルを表示
						</p>
						</div>
					</DropdownMenuLabel>
					...
					<DropdownMenuItem className=" gap-3 ">
						<img className="w-[24px] cursor-pointer" src="ggg.svg" />{" "}
						Google アカウント
					</DropdownMenuItem>
					<DropdownMenuItem className="gap-3 ">
						<img
