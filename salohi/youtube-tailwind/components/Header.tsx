		...
		return (
			...
			<div className="ml-[90px] w-full max-w-[732px] h-[40px] hidden sm:flex justify-end">
				...
				></input>
				<button className=" bg-gray-200 hover:bg-gray-300 shrink-0 w-[64px] h-[40px] relative rounded-r-full border-2 border-solid outline outline-gray-300">
				<img
				...
				<button className="shrink-0 ml-[12px] w-[40px] h-[40px] rounded-full bg-gray-200 hover:bg-gray-300 flex items-center justify-center aspect-square">
				<img
