...
export default function Home() {
  return (
    ...
    <div className="flex items-center justify-center w-[169px] bg-blue-500">
      ...
      <div className="w-[127px] h-[56px] bg-blue-300 ph-[18px] pl-[16px] pr-[14px] shrink-0">
        <img src="logo.svg" alt=""></img>
      </div>
    </div>

    <div className="ml-[90px] w-full max-w-[732px] h-[40px] b-orange-200 hidden sm:flex justify-end">
      {/*search*/}
    ...
    <ul className="flex items-center justify-end w-[225px] h-[40px] bg-red-500 shrink-0">
      ...
      {/*video*/}
      <li className="flex shrink-0 sma:hidden w-[40px] h-[40px] p-2">
        <img className="bg-green-200" src="video.svg" alt=""></img>
      </li>
      {/*bell*/}
      <li className="flex shrink-0 sma:hidden w-[40px] h-[40px] p-2">
        <img className="bg-green-200" src="bell.svg" alt=""></img>
      </li>
      {/*ziynat*/}
      <li className="flex justify-center w-[60px] h-[34px] px-[6px] py-[1px]">
        <img
        className="w-[32px] h-[32px] rounded-full"
        src="youtubeprofile.jpg"
        alt=""
        ></img>
      </li>
    </ul>
