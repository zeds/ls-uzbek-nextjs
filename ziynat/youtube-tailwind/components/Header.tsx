...
export default function Header() {
  ...
  return (
    <div className="fixed top-0 left-0 z-10 flex h-[56px] w-full justify-between items-center bg-white px-3">
      <div className="flex items-center justify-center w-[169px] ">
        <div>
          <img className="w-10 h-10 p-2 shrink-0" src={images.burger} alt="" />
        </div>
        <div>
          <img
