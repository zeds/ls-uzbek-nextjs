    ...
    const [dataMedia, setDataMedia] = useState([
        {
            ...
            title: 'ハックサセックス コーダーズ カップ 2024 Lorem Ipsum is simply dummy text of the',
...

        {
            ...
            title: 'JLPT N1 最終テスト #1 ほのか先生と Lorem Ipsum is simply dummy text of the',
            channelName:'日本語',
            users:'チャンネル登録者数'
...

        {
            ...
            title: 'NVIDIA の Jensen Huang 氏との会話 Lorem Ipsum is simply dummy text of the',
            channelName:'ストライプ',
        ...
        },//https://youtu.be/8Pfa8kPjUio?si=Oe3zARZpyFpJ5HZq
        {
            ...
            title: 'Bethoven Relax Piano Music Lorem Ipsum is simply dummy text of the',
            channelName:'クラシック音楽',
            users:'チャンネル登録者数 24,000'
        },//https://www.youtube.com/live/7nT5YawZt-s?si=jcQ_ez-D2q2w_k_O
        {
            ...
            title: 'CS50x 2024 - Lecture 7 - SQL Lorem Ipsum is simply dummy text of the',
            channelName:'CS50',
        ...
        },//https://www.youtube.com/live/7nT5YawZt-s?si=jcQ_ez-D2q2w_k_O
        {
            ...
            title: '一緒に学ぼう: Hono JS (技術ノートの取り方) Lorem Ipsum is simply dummy text of the',
            channelName:'松山拓也',
            users:'登録者数 12.8 千人'
        },//https://www.youtube.com/live/7nT5YawZt-s?si=jcQ_ez-D2q2w_k_O
        {
